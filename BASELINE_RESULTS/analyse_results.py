...
with open(base_dir / "BASELINE_RESULTS" / "results_baseline_most_frequent.json", "r") as f:
    results = json.load(f)
...
total.to_csv(base_dir / "BASELINE_RESULTS" / f'baseline_most_frequent_metrics_{SPLIT}.csv')