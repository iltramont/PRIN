...
MODEL_NAME_PLOT = "GPT 5.2 - low reasoning"

os.makedirs(base_dir / "immagini" / "gpt-5.2-low-reasoning", exist_ok=True)
image_dir = base_dir / "immagini" / "gpt-5.2-low-reasoning"
