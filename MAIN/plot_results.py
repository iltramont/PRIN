...
MODEL_NAME_PLOT = "Claude Opus 4.6 - Few shots"

os.makedirs(base_dir / "immagini" / "opus-4.6_similar_examples", exist_ok=True)
image_dir = base_dir / "immagini" / "opus-4.6_similar_examples"
